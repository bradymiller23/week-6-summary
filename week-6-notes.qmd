...
* Can come up with $p$-value for a correlatin value to see if 
...
* by adding mroe variables, $R^2$ goes up --> now you can ask what variables leads to the highest increase in $R^2$ /more significant/good predictors and have low variance inflation 
